...
namespace SmartIrc4Net
{
    [Serializable, ComVisible(true)]
    public class ExtendedStreamReader : TextReader
    {
        ...
        private bool _detectUnicode = false;
        ...
        public static readonly ExtendedStreamReader Null = new NullStreamReader();
        private Stream stream;

        internal ExtendedStreamReader()
        {
        }
        ...
        public ExtendedStreamReader(Stream stream, bool detectEncodingFromByteOrderMarks)
            : this(stream, Encoding.UTF8, detectEncodingFromByteOrderMarks, 0x400)
        {
        }

        public ExtendedStreamReader(Stream stream, Encoding encoding,bool detectUTF)
            : this(stream, encoding, true, 0x400)
        {
            _detectUnicode = true;
        }

        public ExtendedStreamReader(string path, bool detectEncodingFromByteOrderMarks)
            : this(path, Encoding.UTF8, detectEncodingFromByteOrderMarks, 0x400)
        {
        }

        public ExtendedStreamReader(string path, Encoding encoding)
            : this(path, encoding, true, 0x400)
        {
        }

        //public ExtendedStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks)
        //    : this(stream, encoding, detectEncodingFromByteOrderMarks, 0x400)
        //{
        //}

        public ExtendedStreamReader(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks)
            : this(path, encoding, detectEncodingFromByteOrderMarks, 0x400)
        {
        }

        public ExtendedStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize)
        {
        ...
        public ExtendedStreamReader(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize)
        {
        ...
        internal ExtendedStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize, bool closable)
        ...
        public override int Read([In, Out] char[] buffer, int index, int count)
        {
            ...
            while (count > 0)
            {
                ...
                if (!readToUserBuffer)
                {
                    Buffer.BlockCopy(this.charBuffer, this.charPos * 2, buffer, (index + num) * 2, num2 * 2);
                    this.charPos += num2;
                }
                num += num2;
                count -= num2;
        ...
        private class NullStreamReader : ExtendedStreamReader
        {
